...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={ref} style={{ padding: "96px 0", background: "var(--black)" }}>
      <div className="container">
        <p className="section-eyebrow" style={{ textAlign: "center" }}>Tech Stack</p>
          ...
          {data.map((group) => (
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                ...
                <h3 style={{ fontFamily: "var(--font-mono)", fontSize: "0.78rem", fontWeight: 600, color: "var(--white)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                  {group.category}
                </h3>
              </div>
              {/* Skills */}
