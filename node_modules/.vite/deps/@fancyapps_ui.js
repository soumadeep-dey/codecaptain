...
var u$4 = null, a$5 = 0;
function c$4() {
	let a = i$5.Initializing, f = o$7.Ease, l = 0, g = 0, p = c$4.Easings.Linear, m = 500, d = 0, b = 0, S = 0, h = 0, y = Infinity, E = .01, R = .01, M = !1, j = {}, w = null, v = {}, O = {}, C = {}, L = 0, I = 0, D = r$4.Loop, z = c$4.Easings.Linear;
...
var h$2 = (e) => {
	e.cancelable && e.preventDefault();
}, m$2 = (e, t = 1e4) => (e = parseFloat(e + "") || 0, Math.round((e + Number.EPSILON) * t) / t), p = (e) => e instanceof HTMLImageElement;
var v, b;
(function(e) {
...
var w$1, M$2 = 0, j = 0, E$1 = 0;
var S = (c, b = {}, S = {}) => {
	let k, O, T, A, C, F, Z, L, P = 0, X = Object.assign(Object.assign({}, x$1), b), Y = {}, R = Object.assign({}, y), z = Object.assign({}, y);
	const D = [];
	function I(e) {
		let t = X[e];
	...
	function V() {
		...
		p(O) && (O.setAttribute("width", e + ""), O.setAttribute("height", t + "")), k && (s$6(k, "has-error"), p(O) && (k.setAttribute("width", e + ""), k.setAttribute("height", t + ""), k.style.aspectRatio = `${e / t || ""}`)), F = c$4().on("start", (e, t) => {
			void 0 !== t.angle && (t.angle = 90 * Math.round(t.angle / 90)), void 0 !== t.flipX && (t.flipX = t.flipX > 0 ? 1 : -1), void 0 !== t.flipY && (t.flipY = t.flipY > 0 ? 1 : -1), z = Object.assign(Object.assign({}, y), t), le(), q("animationStart");
		}).on("pause", (e) => {
			z = Object.assign(Object.assign({}, y), e);
		}).on("step", (e) => {
			if (!W()) return void (null == F || F.end());
			if (R = Object.assign(Object.assign({}, y), e), Q() || !I("bounds") || ye() || z.scale > R.scale || z.scale < oe()) return void ue();
			const t = ae(z.scale);
			let n = !1, o = !1, s = !1, a = !1;
			...
			C = f$1(A, e).on("start", (e) => {
				...
				if (!t) return;
				const n = e.srcEvent;
				(1 !== z.scale || be(z.angle) || e.currentTouch.length > 1) && (h$2(n), ce(v.Pan, e));
			}).on("swipe", (e) => {
				t && (z.scale > 1 || be(z.angle)) && ce(v.Swipe, e);
			}).on("tap", (e) => {
				q("click", e);
			}).on("singleTap", (e) => {
				q("singleClick", e);
				...
				t && (e.scale > oe() ? ce(v.ZoomIn, e) : e.scale < oe() ? ce(v.ZoomOut, e) : ce(v.Pan, e));
			}).on("end", (e) => {
	...
	function U() {
		...
		const o = Object.assign(Object.assign(Object.assign({}, y), e), { scale: n }), i = Q() ? ee(n) : void 0;
		if (i) {
			const { x: e, y: t } = i;
			o.x = e, o.y = t;
		}
	...
	function re() {
		...
		if (z.scale < e - .01 || z.scale > t + .01) return void ce(v.ZoomTo, { scale: n });
	...
	function ce(e, t) {
		...
		switch (e) {
			...
			case v.MoveUp:
				x = t.deltaY || -100;
				break;
			case v.MoveDown: x = t.deltaY || 100;
		}
		let w = [];
		if ("number" == typeof e) s.scale = e;
		else switch (e) {
			case v.Reset:
				s = Object.assign({}, y), s.scale = oe();
				break;
			case v.ZoomTo:
			case v.ZoomIn:
			case v.ZoomOut:
	...
	function de(e = I("clickAction"), t = {}) {
		...
		return e !== v.ZoomTo && (o = t$6(ne(), o, se())), o;
	}
	function fe() {
		return !!(W() && de() > z.scale);
	}
	...
	const Ee = {
		...
		destroy: function() {
			...
			for (const e of D) e();
			return k && (k.style.aspectRatio = "", k.style.maxWidth = "", k.style.maxHeight = ""), A && (A.style.width = "", A.style.height = "", A.style.transform = ""), k = void 0, O = void 0, A = void 0, R = Object.assign({}, y), z = Object.assign({}, y), F?.destroy(), F = void 0, C?.destroy(), C = void 0, P = 4, Ee;
		},
		emit: q,
		execute: ce,
		getBoundaries: ae,
...
var x = (g, M = {}, w = {}) => {
	...
	function lt() {
		...
		if (void 0 === P || r !== P) {
			...
			It(), R = i, !1 !== it("enabled") && (T = 0, rt("init"), function() {
				...
				if (!V || !C) return;
				V.addEventListener("click", Tt), document.addEventListener("mousemove", at), y$1 || (y$1 = function(t) {
					var e, n;
	...
	function At() {
		...
		(function() {
			...
			i = "auto" === i ? Infinity : parseFloat(i + ""), Z = [];
			let o = 0, s = 0;
	...
	function g(t, e) {
		...
		if (o) switch (o.getState()) {
			case 0:
				o.init();
				break;
			case 3: o.execute(v.ZoomTo, Object.assign(Object.assign({}, o.getStartPosition()), { velocity: 0 }));
		}
	}
	function m() {
		var t, e;
...
var s$4 = {
	showLoading: !0,
	preload: 1
}, l$5 = "is-lazyloading", o$4 = "is-lazyloaded", n$4 = "has-lazyerror", i = () => {
	let i;
	function d() {
		const e = null == i ? void 0 : i.getOptions().Lazyload;
		return t$5(e) ? Object.assign(Object.assign({}, s$4), e) : s$4;
	}
	function r(t) {
		var s;
		const r = t.el;
...
var s$3 = {
	...
	function a(o) {
		const r = function() {
			...
			return t$5(t) ? Object.assign(Object.assign({}, s$3), t) : s$3;
...
/*! License details at fancyapps.com/license */
var t$1 = "<circle cx=\"11\" cy=\"11\" r=\"7.5\"/><path d=\"m21 21-4.35-4.35M8 11h6\"/>", M$1 = "<g><line x1=\"11\" y1=\"8\" x2=\"11\" y2=\"14\"></line></g><circle cx=\"11\" cy=\"11\" r=\"7.5\"/><path d=\"m21 21-4.35-4.35M8 11h6\"/>", o$3 = {
	moveLeft: [
		"moveLeft",
		"MOVE_LEFT",
...
for (const t of Object.keys(o$3)) {
	const M = o$3[t];
	v$2[t] = { tpl: `<button data-panzoom-action="${M[0]}" class="f-button" title="{{${M[1]}}}"><svg>${M[2]}</svg></button>` };
}
//#endregion
...
var c = () => {
	...
	function w() {
		...
		const o = r$2({}, {
			...
			slidesPerPage: (t) => {
				...
				}(), e = 4 * (h - v)), t && t.getTotalSlideDim() <= t.getViewportDim() - e ? Infinity : 1;
			}
	...
	return {
		init: function(t, e) {
			a$2 = e, c = t, c.on("ready", A), c.on("initSlides", j), c.on("change", O);
		},
		destroy: function() {
			var t, e;
...
var i$3 = (t, e = {}) => {
	...
	function c() {
		...
		return t$5(t) ? Object.assign(Object.assign({}, l$4), t) : l$4;
	}
	function a() {
		var t;
	...
	function m(t, e) {
		...
		if (!l || "youtube" === l) {
			...
			if (t) {
				const o = Object.assign(Object.assign({}, c().youtube), e.youtube || {}), s = `www.youtube${o.nocookie ? "-nocookie" : ""}.com`, r = i$3(n, o), a = encodeURIComponent(t[2]);
		...
		if (!l || "vimeo" === l) {
			...
			if (t) {
				const s = i$3(n, Object.assign(Object.assign({}, c().vimeo), e.vimeo || {})), r = encodeURIComponent(t[2]), a = t[5] || "";
...
/*! License details at fancyapps.com/license */
var n, o$2, r = !1, i$2 = !1, l$3 = !1, s$2 = !1;
var a$1 = () => {
	...
	if (!n) return;
	if (u()) return;
	const { urlSlug: t, urlIndex: e } = a$1();
	if (!t) return;
	...
	if (!n) return;
	if (l$3) return;
	const t = null == n ? void 0 : n.getInstance(), o = null == t ? void 0 : t.getCarousel(), { urlSlug: r, urlIndex: u } = a$1(), d = null == t ? void 0 : t.getOptions().Hash;
	if (!1 !== d) {
		if (t && 1 === t.getState() && o) {
			const n = o.getSlides();
			for (const t of n || []) if (t.slug === r || (t.fancybox === r || t$5(d) && d.slug === r) && t.index === u - 1) return i$2 = !1, void o.goTo(t.index);
			s$2 = !0, t.close(), s$2 = !1;
		}
		c$2();
	}
...
var m = () => {
	...
	function u() {
		...
		const l = d(t);
		if (!l) return;
		const { urlHash: s, urlSlug: u } = a$1(), f = g(t);
		s !== f && (e = s), history.scrollRestoration && !w && (w = history.scrollRestoration, history.scrollRestoration = "manual", window.addEventListener("beforeunload", v$1)), o.on("change", c);
		const h = l !== u;
		try {
			window.history[h ? "pushState" : "replaceState"]({}, document.title, window.location.pathname + window.location.search + f), h && (i$2 = !0);
		} catch (t) {}
	}
	function c() {
		if (!t || !t.isTopMost() || !1 === t.getOptions().Hash) return;
	...
	function f() {
		var n;
		if (!t || !t.isTopMost() || !1 === t.getOptions().Hash || s$2) return;
		if (d(t)) {
			l$3 = !0;
			try {
				i$2 && !function() {
	...
	return {
		init: function(e) {
			clearTimeout(o$2), t = e, t.on("ready", u), t.on("close", f);
		},
		destroy: function() {
			t?.off("ready", u), t?.off("close", f);
			const e = null == t ? void 0 : t.getCarousel();
			e && e.off("change", c), t = void 0, null != n && n.getInstance() || (v$1(), window.removeEventListener("beforeunload", v$1));
		}
	};
};
m.getInfoFromURL = a$1, m.startFromUrl = c$2, m.setup = function(e) {
...
/*! License details at fancyapps.com/license */
var o$1 = Object.assign(Object.assign({}, o$5), {
	CLOSE: "Close",
	NEXT: "Next",
	PREV: "Previous",
	...
	function le() {
		...
		(function() {
			...
			function r() {
				...
				if (i && s) if (0 === o) s.execute(v.Reset);
				else {
					const e = t$3(Math.abs(n), 0, .33 * i, l, .77 * l, !1);
					s.execute(v.ZoomTo, { scale: e });
				}
			}
			const c = (e) => {
				var t;
	...
	function Me(e, t) {
		...
		if (M && s && l && a && c) {
			...
			if (Z("zoomEffect") && 1 === s.state && (e = we(s)), e) {
				...
				a.on("refresh", () => {
					t();
				}), c.easing(c$4.Easings.EaseOut).duration(350).from(Object.assign({}, a.getTransform())).to(Object.assign(Object.assign({}, y), e)).start(), null != l && l.getAnimations() && (l.style.animationPlayState = "paused", requestAnimationFrame(() => {
					t();
				}));
			}
		}
...
//#endregion
//#region node_modules/@fancyapps/ui/dist/index.js
/*! License details at fancyapps.com/license */
//#endregion
export { l as Arrows, o as Autoplay, x as Carousel, F as Fancybox, _ as FancyboxState, l$1 as Fullscreen, l$2 as Html, i as Lazyload, y as PANZOOM_DEFAULT_POS, S as Panzoom, v as PanzoomAction, b as PanzoomZoomLevel, i$1 as Sync, c as Thumbs, c$1 as Toolbar, a as ToolbarColumn, s as Video, s$1 as Zoomable };
